...
def load_image(path):
    ...
    image = image[np.newaxis,:IMAGE_HEIGHT,:IMAGE_WIDTH,:] 
...
def load_vgg_model(path):
    ...
    def _weights(expected_layer_name):
        ...
        """
        W = vgg[expected_layer_name+'_W']
        b = vgg[expected_layer_name+'_b']
    ...
    graph['conv1_1']  = _conv2d_relu(graph['input'], 'conv1_1')
    graph['conv1_2']  = _conv2d_relu(graph['conv1_1'], 'conv1_2')
    graph['avgpool1'] = _avgpool(graph['conv1_2'])
    graph['conv2_1']  = _conv2d_relu(graph['avgpool1'], 'conv2_1')
    graph['conv2_2']  = _conv2d_relu(graph['conv2_1'], 'conv2_2')
    graph['avgpool2'] = _avgpool(graph['conv2_2'])
    graph['conv3_1']  = _conv2d_relu(graph['avgpool2'], 'conv3_1')
    graph['conv3_2']  = _conv2d_relu(graph['conv3_1'], 'conv3_2')
    graph['conv3_3']  = _conv2d_relu(graph['conv3_2'], 'conv3_3')
    graph['avgpool3'] = _avgpool(graph['conv3_3'])
    graph['conv4_1']  = _conv2d_relu(graph['avgpool3'], 'conv4_1')
    graph['conv4_2']  = _conv2d_relu(graph['conv4_1'], 'conv4_2')
    graph['conv4_3']  = _conv2d_relu(graph['conv4_2'], 'conv4_3')
    graph['avgpool4'] = _avgpool(graph['conv4_3'])
    graph['conv5_1']  = _conv2d_relu(graph['avgpool4'], 'conv5_1')
    graph['conv5_2']  = _conv2d_relu(graph['conv5_1'], 'conv5_2')
    graph['conv5_3']  = _conv2d_relu(graph['conv5_2'], 'conv5_3')
